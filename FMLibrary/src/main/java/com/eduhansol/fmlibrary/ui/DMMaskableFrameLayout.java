...
import com.eduhansol.fmlibrary.R;


public class DMMaskableFrameLayout extends FrameLayout {
    ...
    public DMMaskableFrameLayout(Context context) {
        super(context);
    }

    public DMMaskableFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public DMMaskableFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = DMMaskableFrameLayout.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = DMMaskableFrameLayout.this.getViewTreeObserver();
                    }
